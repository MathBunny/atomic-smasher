...
/** Credits go to Daniel Chen for the code, implemented by Horatiu Lazu and Andrew Nitu.
  * 
...
public class Print implements Printable 
{
   ...
   * up.
   * @param p PrinterJob This is a PrinterJob reference.
   * @param e PrinterException This is an event variable.
   * @throws PrinterException This is used in case of a printing exception.
   ...
   * @param Graphics2D g2d This is a reference to the 2D graphics class.
   * @param pageWidth double This is the width of the page.
   * @param pageHeight double This is the length of the page.
   * @param fm FontMetrics This is the metrics of the font.
